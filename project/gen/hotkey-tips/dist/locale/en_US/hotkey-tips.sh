...
"Win + w" "Window Maximize" "#ffffff" "Monospace 16" \
"Win + x" "Window Minimize" "#cccccc" "Monospace 16" \
...
"Win + t" "Window Always on Top" "#cccccc" "Monospace 16" \
"Win + b" "Window Always on Bottom" "#ffffff" "Monospace 16" \
"Win + y" "Window Toggle Shade" "#cccccc" "Monospace 16" \
"Win + n" "Window Toggle Show or Hide Decoration" "#ffffff" "Monospace 16" \
"Win + z" "Window Toggle Raise or Lower" "#cccccc" "Monospace 16" \
"Win + m" "Window Move Center" "#ffffff" "Monospace 16" \
"Win + ;" "Window Decrease Opacity" "#cccccc" "Monospace 16" \
"Win + '" "Window Increase Opacity" "#ffffff" "Monospace 16" \
